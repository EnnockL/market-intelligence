...
export default async function Dashboard() {
  ...
  return <main>
    ...
    <WalletDiscoveryPanel data={walletDiscovery} /><div id="fast-flow"><FastFlowPanel data={fastFlow} /></div><JackpotRadar data={jackpot} /><PaperPortfolioPanel data={paper} /><QualificationDiagnostics data={qualification} />
    <section className="intelligence-grid intelligence-grid--single"><div><DataStatus mode={stockData.mode} updatedAt={stockData.updatedAt} message={stockData.message} provider={stockData.provider} /><StockRadarPanel stocks={stockData.stocks} /></div></section>
