...
import { getFastFlowData } from "@/data/opportunity-data";
import { FastFlowPanel } from "@/components/dashboard/fast-flow-panel";

export const dynamic = "force-dynamic";

export default async function Dashboard() {
  const [stockData, walletDiscovery, fastFlow] = await Promise.all([getDashboardStockData(), getWalletDiscoveryData(), getFastFlowData()]);
  return <main>
