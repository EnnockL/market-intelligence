...
import {
  ...
  StockRadarPanel,
  WatchlistPanel,
} from "@/components/dashboard/intelligence-panels";
    ...
    <main>
      <section className="hero">
        <div>
          ...
          <p>
            Deterministic signals, ranked by opportunity. Every score is
        ...
        <div className="last-scan">
          ...
          <strong>{stockData.mode.toUpperCase()}</strong>
          <small>{stockData.message}</small>
        </div>
      </section>
      ...
      <footer>
        ...
        <span>
          V0.4 · STOCKS {stockData.mode.toUpperCase()} · WALLETS{" "}
          {walletDiscovery.mode.toUpperCase()} · PAPER ONLY
        </span>
      </footer>
    </main>
  );
