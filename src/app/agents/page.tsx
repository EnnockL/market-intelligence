...
const SYSTEMS=[{label:"Simulation Engine",layer:"BACKTEST",href:"/simulation",description:"Point-in-time capital, fees, slippage, liquidity and policy comparison."},{label:"Historical Replay",layer:"REPLAY",href:"/replay",description:"Reconstructs only information available at the selected historical cutoff."},{label:"Strategy Pattern Lab",layer:"RESEARCH",href:"/strategy-lab",description:"Tests immutable technical strategy definitions on historical candles."},{label:"Strategy Validation",layer:"GOVERNANCE",href:"/strategy-validation",description:"Freezes hypotheses, validates out-of-sample edge and keeps runtime decisions at NO_TRADE until every gate passes."},{label:"Performance Engine",layer:"MEASUREMENT",href:"/paper",description:"Measures policy funnels, fills, PnL and blockers.",jobType:"AGENT_PERFORMANCE"},{label:"Forecast Calibration",layer:"FORECAST",href:"/forecasts",description:"Tracks forecast outcomes and calibration without invented probabilities.",jobType:"FORECAST_PERFORMANCE"}] as const;
