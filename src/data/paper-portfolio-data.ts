    ...
    return {
      ...
      portfolios: (data ?? []).map((p: any) => {
        const positions = p.paper_positions ?? [],
          ...
          performance =
            [...(p.performance_snapshots ?? [])].sort((a: any, b: any) =>
