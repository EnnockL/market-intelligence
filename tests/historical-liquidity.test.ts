...
import { classifyExecutionCapacity, liquiditySnapshotFromObservation, selectPointInTimeLiquidity, type LiquiditySnapshot } from "../src/domain/historical-liquidity";
...
describe("historical liquidity", () => {
  ...
  it("turns only complete forward pool observations into replay-safe snapshots", () => {
    expect(liquiditySnapshotFromObservation({ assetId: "asset", poolAddress: "pool", liquidityUsd: 125_000, observedAt: "2026-08-17T10:00:00Z", provider: "dexscreener", confidence: 75 }))
      .toMatchObject({ poolAddress: "pool", liquidityUsd: 125_000, effectiveAt: "2026-08-17T10:00:00.000Z", informationAvailableAt: "2026-08-17T10:00:00.000Z", provider: "dexscreener-forward-observation", quality: 75 });
    expect(liquiditySnapshotFromObservation({ assetId: "asset", poolAddress: null, liquidityUsd: 125_000, observedAt: "2026-08-17T10:00:00Z", provider: "dexscreener", confidence: 75 })).toBeNull();
  });
});
